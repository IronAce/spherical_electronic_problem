...
class spherical_harmonics: public constants {
  ...
  public:
    void spherical_harmonics_init( int & lmax_in , int Ntheta_in , int Nphi_in );
    int basis_set_size( void ) ;
    void del_spherical_harmonics( void ) ;
...
************************************************/
void spherical_harmonics::spherical_harmonics_init( int & lmax_in , int Ntheta_in , int Nphi_in ){
...
******************************************************/
void spherical_harmonics::del_spherical_harmonics( void ){
